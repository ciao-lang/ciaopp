...
%------------------------------------------------------------------------|
% exit_to_prime(+,+,+,+,+,+,-)                                       |
% exit_to_prime(Sg,Hv,Head,_,Exit,ExtraInfo,Prime)                   |
...
%------------------------------------------------------------------------- |
% call_to_prime_fact/6 obtains the abstract prime substitution         |
...
%-------------------------------------------------------------------------
% success_builtin(+,+,+,+,+,-)                                       |
% success_builtin(Type,Sv_u,Condv,_HvFv_u,Call,Succ)                         |
...
% groundness_propagate(OldBinds,Gv1,Gv2,Proj,NewBinds,NewProj,Gv)    |
...
%------------------------------------------------------------------------- |
% unify_each(+,+,+,-,-)                                                |
% unify_each(S1h,Sh2,[],NewNonLinear,NewSh)                            |
