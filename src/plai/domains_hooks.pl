...
:- dom_op(frdef, exit_to_prime(Sg,Hv,Head,Sv,Exit,ExtraInfo,Prime), ok(exit_to_prime(Exit,Sg,Hv,Head,Sv,ExtraInfo,Prime))).
:- dom_op(frdef, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
...
:- dom_op(frdef, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(lsign, exit_to_prime(Sg,Hv,Head,_Sv,Exit,ExtraInfo,Prime), ok(exit_to_prime(Sg,Hv,Head,Exit,ExtraInfo,Prime))).
:- dom_op(lsign, project(_Sg,Vars,HvFv,ASub,Proj), ok(project(ASub,Vars,HvFv,Proj))).
...
:- dom_op(lsign, abs_subset(LASub1,LASub2), ok(is_subset(LASub1,LASub2))).
...
:- dom_op(difflsign, exit_to_prime(Sg,Hv,Head,_Sv,Exit,ExtraInfo,Prime), ok(exit_to_prime(Sg,Hv,Head,Exit,ExtraInfo,Prime))).
...
:- dom_op(gr, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(gr, compute_lub/2).
:- dom_op(gr, abs_sort/2).
:- dom_op(gr, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(gr, less_or_equal/2).
:- dom_op(gr, glb/3).
:- dom_op(gr, call_to_success_fact/9).
:- dom_op(gr, special_builtin/5).
:- dom_op(gr, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(gr, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
% :- dom_op(gr, extend_free(ASub1,Vars,ASub), ok(extend_free(ASub1,Vars,ASub))).
% ---------------------------------------------------------------------------
:- use_module(domain(def)).
:- dom_def(def).
:- dom_op(def, call_to_entry/9).
:- dom_op(def, exit_to_prime(Sg,Hv,Head,Sv,Exit,ExtraInfo,Prime), ok(exit_to_prime(Exit,ExtraInfo,Hv,Sv,Head,Sg,Prime))).
:- dom_op(def, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(def, compute_lub/2).
:- dom_op(def, abs_sort/2).
:- dom_op(def, extend(_Sg,Prime,_Sv,Call,Succ), ok(extend(Prime,Call,Succ))).
:- dom_op(def, less_or_equal/2).
:- dom_op(def, glb/3).
:- dom_op(def, call_to_success_fact/9).
:- dom_op(def, special_builtin/5).
:- dom_op(def, success_builtin(Type,_Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Condvars,Call,Succ))).
...
% :- dom_op(def, propagate_downwards_closed(ASub1,ASub2,ASub), ok(downwards_closed(ASub1,ASub2,ASub))).
% :- dom_op(def, del_real_conjoin(ASub1,ASub2,ASub), ok(real_conjoin(ASub1,ASub2,ASub))).
% :- dom_op(def, del_hash(ASub,Vars,N), ok(hash(ASub,Vars,N))).
% :- dom_op(def, more_instantiate(ASub1,ASub2), ok(less_or_equal(ASub2,ASub1))).
% :- dom_op(def, convex_hull(Old,_,Old)).
% :- dom_op(def, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
% :- dom_op(def, del_check_cond(Cond,ASub,Sv,Flag,WConds), ok(check_cond(Cond,ASub,Sv,Flag,WConds))).
% :- dom_op(def, del_impose_cond(LCond,Sv,ASub,LASub), ok(impose_cond(LCond,Sv,ASub,LASub))).
%
...
:- dom_op(share, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(share, less_or_equal/2).
:- dom_op(share, glb/3).
:- dom_op(share, call_to_success_fact/9).
:- dom_op(share, special_builtin/5).
:- dom_op(share, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(share, compute_lub_el(ASub1,ASub2,ASub), ok(lub(ASub1,ASub2,ASub))).
% ----------
...
:- dom_op(shfr, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(shfr, less_or_equal/2).
:- dom_op(shfr, glb/3).
:- dom_op(shfr, call_to_success_fact/9).
:- dom_op(shfr, special_builtin/5).
:- dom_op(shfr, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(shfr, call_to_success_builtin/6).
:- dom_op(shfr, obtain_info(Prop,Vars,ASub,Info), ok(obtain(Prop,Vars,ASub,Info))).
...
% :- dom_op(shfr, propagate_downwards_closed(ASub1,ASub2,ASub), ok(downwards_closed(ASub1,ASub2,ASub))).
% :- dom_op(shfr, del_real_conjoin(ASub1,ASub2,ASub), ok(real_conjoin(ASub1,ASub2,ASub))).
% :- dom_op(shfr, del_hash(ASub,Vars,N), ok(hash(ASub,Vars,N))).
% :- dom_op(shfr, more_instantiate(ASub1,ASub2), ok(more_instantiate(ASub1,ASub2))).
% :- dom_op(shfr, convex_hull(Old,New,Hull), ok(convex_hull(Old,New,Hull))).
% :- dom_op(shfr, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
% :- dom_op(shfr, extend_free(ASub1,Vars,ASub), ok(extend_free(ASub1,Vars,ASub))).
% :- dom_op(shfr, del_check_cond(Cond,ASub,Sv,Flag,WConds), ok(check_cond(Cond,ASub,Sv,Flag,WConds))).
% :- dom_op(shfr, del_impose_cond(LCond,Sv,ASub,LASub), ok(impose_cond(LCond,Sv,ASub,LASub))).
%
...
:- dom_op(shfrnv, project(_Sg,Vars,_HvFv,ASub,Proj), from(shfr,project(ASub,Vars,Proj))).
:- dom_op(shfrnv, compute_lub/2).
:- dom_op(shfrnv, abs_sort(ASub,ASub_s), from(shfr,abs_sort(ASub,ASub_s))).
:- dom_op(shfrnv, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(shfrnv, less_or_equal/2).
:- dom_op(shfrnv, glb/3).
:- dom_op(shfrnv, call_to_success_fact/9).
:- dom_op(shfrnv, special_builtin(SgKey,Sg,Subgoal,Type,Condvars), from(shfr,special_builtin(SgKey,Sg,Subgoal,Type,Condvars))).
:- dom_op(shfrnv, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(shfrnv, unknown_call(Sg,Vars,Call,Succ), from(shfr,unknown_call(Sg,Vars,Call,Succ))).
:- dom_op(shfrnv, unknown_entry(Sg,Qv,Call), from(shfr,unknown_entry(Sg,Qv,Call))).
:- dom_op(shfrnv, empty_entry(Sg,Qv,Call), from(shfr,empty_entry(Sg,Qv,Call))).
%
% :- dom_op(shfrnv, propagate_downwards_closed(ASub1,ASub2,ASub), ok(downwards_closed(ASub1,ASub2,ASub))).
% :- dom_op(shfrnv, del_real_conjoin(ASub1,ASub2,ASub), ok(real_conjoin(ASub1,ASub2,ASub))).
% :- dom_op(shfrnv, del_hash(ASub,Vars,N), ok(hash(ASub,Vars,N))).
% :- dom_op(shfrnv, more_instantiate(ASub1,ASub2), ok(more_instantiate(ASub1,ASub2))).
% :- dom_op(shfrnv, convex_hull(Old,New,Hull), ok(convex_hull(Old,New,Hull))).
% :- dom_op(shfrnv, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
% :- dom_op(shfrnv, extend_free(ASub1,Vars,ASub), from(shfr,extend_free(ASub1,Vars,ASub))).
% :- dom_op(shfrnv, del_check_cond(Cond,ASub,Sv,Flag,WConds), ok(check_cond(Cond,ASub,Sv,Flag,WConds))).
% :- dom_op(shfrnv, del_impose_cond(LCond,Sv,ASub,LASub), ok(impose_cond(LCond,Sv,ASub,LASub))).
%
...
:- dom_op(shfret, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
...
:- dom_op(shfret, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(shfret, less_or_equal/2).
:- dom_op(shfret, glb/3).
:- dom_op(shfret, eliminate_equivalent/2).
:- dom_op(shfret, call_to_success_fact/9).
:- dom_op(shfret, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(shfret, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
...
:- dom_op(shareson, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(shareson, compute_lub/2).
:- dom_op(shareson, abs_sort/2).
:- dom_op(shareson, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(shareson, body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ), ok(body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ))).
...
:- dom_op(shfrson, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(shfrson, compute_lub/2).
:- dom_op(shfrson, abs_sort/2).
:- dom_op(shfrson, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(shfrson, less_or_equal/2).
:- dom_op(shfrson, glb/3).
:- dom_op(shfrson, call_to_success_fact/9).
:- dom_op(shfrson, special_builtin/5).
:- dom_op(shfrson, body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ), ok(body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ))).
...
:- dom_op(son, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(son, compute_lub/2).
:- dom_op(son, abs_sort/2).
:- dom_op(son, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(son, less_or_equal/2).
:- dom_op(son, glb/3).
:- dom_op(son, call_to_success_fact/9).
:- dom_op(son, special_builtin/5).
:- dom_op(son, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(son, compute_lub_el(ASub1,ASub2,ASub), ok(lub(ASub1,ASub2,ASub))).
% ---------------------------------------------------------------------------
...
:- dom_op(share_amgu, compute_lub(ListAsub,LubASub), from(share,compute_lub(ListAsub,LubASub))).
:- dom_op(share_amgu, abs_sort(ASub,ASub_s), from(share,abs_sort(ASub,ASub_s))).
:- dom_op(share_amgu, extend(_Sg,Prime,Sv,Call,Succ), from(share,extend(Prime,Sv,Call,Succ))).
:- dom_op(share_amgu, less_or_equal(ASub0,ASub1), from(share,less_or_equal(ASub0,ASub1))).
:- dom_op(share_amgu, glb(ASub0,ASub1,ASub), from(share,glb(ASub0,ASub1,ASub))).
:- dom_op(share_amgu, call_to_success_fact/9).
:- dom_op(share_amgu, special_builtin/5).
:- dom_op(share_amgu, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(share_amgu, call_to_success_builtin/6).
:- dom_op(share_amgu, input_interface(InputUser,Kind,Struct0,Struct1), from(share,input_interface(InputUser,Kind,Struct0,Struct1))).
:- dom_op(share_amgu, input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub), from(share,input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub))).
:- dom_op(share_amgu, asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps), from(share,asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps))).
:- dom_op(share_amgu, unknown_call(Sg,Vars,Call,Succ), from(share,unknown_call(Sg,Vars,Call,Succ))).
:- dom_op(share_amgu, unknown_entry(Sg,Qv,Call), from(share,unknown_entry(Sg,Qv,Call))).
:- dom_op(share_amgu, empty_entry(Sg,Qv,Call), from(share,empty_entry(Sg,Qv,Call))).
% :- dom_op(share_amgu, compute_lub_el(ASub1,ASub2,ASub), from(share,lub(ASub1,ASub2,ASub))).
% ----------
...
:- dom_op(sharefree_amgu, compute_lub(ListAsub,LubASub), from(shfr,compute_lub(ListAsub,LubASub))).
:- dom_op(sharefree_amgu, abs_sort(ASub,ASub_s), from(shfr,abs_sort(ASub,ASub_s))).
:- dom_op(sharefree_amgu, extend(_Sg,Prime,Sv,Call,Succ), from(shfr,extend(Prime,Sv,Call,Succ))).
:- dom_op(sharefree_amgu, less_or_equal(ASub0,ASub1), from(shfr,less_or_equal(ASub0,ASub1))).
:- dom_op(sharefree_amgu, glb(ASub0,ASub1,ASub), from(shfr,glb(ASub0,ASub1,ASub))).
:- dom_op(sharefree_amgu, call_to_success_fact/9).
:- dom_op(sharefree_amgu, special_builtin/5).
:- dom_op(sharefree_amgu, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(sharefree_amgu, call_to_success_builtin/6).
:- dom_op(sharefree_amgu, obtain_info(Prop,Vars,ASub,Info), from(shfr,obtain(Prop,Vars,ASub,Info))).
:- dom_op(sharefree_amgu, input_interface(InputUser,Kind,Struct0,Struct1), from(shfr,input_interface(InputUser,Kind,Struct0,Struct1))).
:- dom_op(sharefree_amgu, input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub), from(shfr,input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub))).
:- dom_op(sharefree_amgu, asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps), from(shfr,asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps))).
:- dom_op(sharefree_amgu, unknown_call(Sg,Vars,Call,Succ), from(shfr,unknown_call(Sg,Vars,Call,Succ))).
:- dom_op(sharefree_amgu, unknown_entry(Sg,Qv,Call), from(shfr,unknown_entry(Sg,Qv,Call))).
:- dom_op(sharefree_amgu, empty_entry(Sg,Qv,Call), from(shfr,empty_entry(Sg,Qv,Call))).
% ----------
...
:- dom_op(shfrlin_amgu, compute_lub(ListAsub,LubASub), from(shfrlin,compute_lub(ListAsub,LubASub))).
:- dom_op(shfrlin_amgu, abs_sort(ASub,ASub_s), from(shfrlin,sort(ASub,ASub_s))).
:- dom_op(shfrlin_amgu, extend(_Sg,Prime,Sv,Call,Succ), from(shfrlin,extend(Prime,Sv,Call,Succ))).
:- dom_op(shfrlin_amgu, less_or_equal(ASub0,ASub1), from(shfrlin,less_or_equal(ASub0,ASub1))).
:- dom_op(shfrlin_amgu, glb(ASub0,ASub1,ASub), from(shfrlin,glb(ASub0,ASub1,ASub))).
:- dom_op(shfrlin_amgu, call_to_success_fact(Sg,Hv,Head,K,Sv,Call,Proj,Prime,Succ), from(shfrlin,call_to_success_fact(Sg,Hv,Head,K,Sv,Call,Proj,Prime,Succ))).
:- dom_op(shfrlin_amgu, special_builtin(SgKey,Sg,Subgoal,Type,Condvars), from(shfrlin,special_builtin(SgKey,Sg,Subgoal,Type,Condvars))).
:- dom_op(shfrlin_amgu, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), from(shfrlin,success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(shfrlin_amgu, call_to_success_builtin(SgKey,Sg,Sv,Call,Proj,Succ), from(shfrlin,call_to_success_builtin(SgKey,Sg,Sv,Call,Proj,Succ))).
:- dom_op(shfrlin_amgu, obtain_info(Prop,Vars,(Sh,Fr,_Lin),Info), from(shfr,obtain(Prop,Vars,(Sh,Fr),Info))).
:- dom_op(shfrlin_amgu, input_interface(InputUser,Kind,Struct0,Struct1), from(shfrlin,input_interface(InputUser,Kind,Struct0,Struct1))).
:- dom_op(shfrlin_amgu, input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub), from(shfrlin,input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub))).
:- dom_op(shfrlin_amgu, asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps), from(shfrlin,asub_to_native(ASub,Qv,OutFlag,OutputUser,Comps))).
:- dom_op(shfrlin_amgu, unknown_call(Sg,Vars,Call,Succ), from(shfrlin,unknown_call(Sg,Vars,Call,Succ))).
:- dom_op(shfrlin_amgu, unknown_entry(Sg,Qv,Call), from(shfrlin,unknown_entry(Sg,Qv,Call))).
:- dom_op(shfrlin_amgu, empty_entry(Sg,Qv,Call), from(shfrlin,empty_entry(Sg,Qv,Call))).
% ---------------------------------------------------------------------------
...
:- dom_op(share_clique, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(share_clique, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(share_clique, compute_lub_el(ASub1,ASub2,ASub), ok(lub_cl(ASub1,ASub2,ASub))).
% ----------
...
:- dom_op(share_clique_1, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(share_clique_1, compute_lub/2).
:- dom_op(share_clique_1, identical_abstract/2).
:- dom_op(share_clique_1, abs_sort(ASub,ASub_s), from(share_clique,abs_sort(ASub,ASub_s))).
:- dom_op(share_clique_1, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(share_clique_1, special_builtin(SgKey,Sg,Subgoal,Type,Condvars), from(share_clique,special_builtin(SgKey,Sg,Subgoal,Type,Condvars))).
:- dom_op(share_clique_1, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(share_clique_1, call_to_success_builtin/6).
:- dom_op(share_clique_1, input_interface/4).
:- dom_op(share_clique_1, input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub), from(share_clique,input_user_interface(InputUser,Qv,ASub,Sg,MaybeCallASub))).
:- dom_op(share_clique_1, asub_to_native/5).
:- dom_op(share_clique_1, unknown_call/4).
:- dom_op(share_clique_1, unknown_entry/3).
:- dom_op(share_clique_1, empty_entry(Sg,Qv,Call), from(share_clique,empty_entry(Sg,Qv,Call))).
% :- dom_op(share_clique_1, compute_lub_el(ASub1,ASub2,ASub), ok(lub_cl(ASub1,ASub2,ASub))).
% ----------
...
:- dom_op(sharefree_clique, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(sharefree_clique, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(sharefree_clique, call_to_success_builtin/6).
:- dom_op(sharefree_clique, obtain_info(Prop,Vars,ASub,Info), from(shfr,obtain(Prop,Vars,ASub,Info))).
...
% :- dom_op(sharefree_clique, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
% ----------
...
:- dom_op(share_clique_def, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(share_clique_def, compute_lub/2).
:- dom_op(share_clique_def, identical_abstract/2).
:- dom_op(share_clique_def, abs_sort/2).
:- dom_op(share_clique_def, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(share_clique_def, body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ), ok(body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ))).
:- dom_op(share_clique_def, input_interface(InputUser,Kind,Struct0,Struct1), from(share_clique,input_interface(InputUser,Kind,Struct0,Struct1))).
...
% :- dom_op(share_clique_def, compute_lub_el(ASub1,ASub2,ASub), ok(lub_cl(ASub1,ASub2,ASub))).
%
% ----------
...
:- dom_op(sharefree_clique_def, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(sharefree_clique_def, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(sharefree_clique_def, body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ), ok(body_succ_builtin(Type,Sg,Condvs,Sv,HvFv_u,Call,Proj,Succ))).
:- dom_op(sharefree_clique_def, input_interface(InputUser,Kind,Struct0,Struct1), from(sharefree_clique,input_interface(InputUser,Kind,Struct0,Struct1))).
...
% :- dom_op(sharefree_clique_def, compute_lub_el(ASub1,ASub2,ASub), ok(lub_cl(ASub1,ASub2,ASub))).
% ---------------------------------------------------------------------------
...
:- dom_op(bshare, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(bshare, compute_lub_el(ASub1,ASub2,ASub), ok(compute_lub_el(ASub1,ASub2,ASub))).
:- endif.
% ===========================================================================
...
:- dom_op(aeq, exit_to_prime(Sg,Hv,Head,Sv,Exit,ExtraInfo,Prime), ok(exit_to_prime(Exit,Sg,Hv,Head,Sv,ExtraInfo,Prime))).
:- dom_op(aeq, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(aeq, compute_lub/2).
:- dom_op(aeq, identical_abstract/2).
:- dom_op(aeq, abs_sort/2).
:- dom_op(aeq, extend(_Sg,Prime,_Sv,Call,Succ), ok(extend(Prime,Call,Succ))).
:- dom_op(aeq, less_or_equal/2).
:- dom_op(aeq, glb/3).
:- dom_op(aeq, eliminate_equivalent/2).
:- dom_op(aeq, call_to_success_fact/9).
:- dom_op(aeq, special_builtin(Sg_key,Sg,Subgoal,Type,Condvars), ok(special_builtin(Sg_key,Sg,Subgoal,Type,Condvars))).
:- dom_op(aeq, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
%
% :- dom_op(aeq, propagate_downwards_closed(ASub1,ASub2,ASub), ok(downwards_closed(ASub1,ASub2,ASub))).
% :- dom_op(aeq, del_real_conjoin(ASub1,ASub2,ASub), ok(real_conjoin(ASub1,ASub2,ASub))).
% :- dom_op(aeq, del_hash(ASub,Vars,N), ok(hash(ASub,Vars,N))).
% :- dom_op(aeq, more_instantiate(ASub1,ASub2), ok(more_instantiate(ASub1,ASub2))).
% :- dom_op(aeq, convex_hull(Old,New,Hull), ok(convex_hull(Old,New,Hull))).
% :- dom_op(aeq, compute_lub_el(ASub1,ASub2,ASub), ok(lub(ASub1,ASub2,ASub))).
% :- dom_op(aeq, extend_free(ASub1,Vars,ASub), ok(extend_free(ASub1,Vars,ASub))).
% :- dom_op(aeq, del_check_cond(Cond,ASub,Sv,Flag,WConds), ok(check_cond(Cond,ASub,Sv,Flag,WConds))).
% :- dom_op(aeq, del_impose_cond(LCond,Sv,ASub,LASub), ok(impose_cond(LCond,Sv,ASub,LASub))).
%
...
:- dom_op(depthk, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(depthk, compute_lub/2).
:- dom_op(depthk, identical_abstract/2).
:- dom_op(depthk, abs_sort(ASub,ASub_s), ok(sort(ASub,ASub_s))).
:- dom_op(depthk, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(depthk, less_or_equal/2).
:- dom_op(depthk, glb/3).
:- dom_op(depthk, eliminate_equivalent/2).
:- dom_op(depthk, abs_subset(LASub1,LASub2), ok(abs_subset(LASub1,LASub2))).
:- dom_op(depthk, call_to_success_fact/9).
:- dom_op(depthk, special_builtin/5).
:- dom_op(depthk, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(depthk, call_to_success_builtin(_SgKey,Sg,Sv,Call,_Proj,Succ), ok(call_to_success_builtin(Sg,Sv,Call,Succ))).
...
:- dom_op(path, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
:- dom_op(path, compute_lub/2).
:- dom_op(path, abs_sort/2).
:- dom_op(path, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(path, less_or_equal/2).
:- dom_op(path, glb/3).
:- dom_op(path, call_to_success_fact/9).
:- dom_op(path, special_builtin/5).
:- dom_op(path, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(terms, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(terms, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(terms, less_or_equal/2).
:- dom_op(terms, glb/3).
:- dom_op(terms, call_to_success_fact/9).
:- dom_op(terms, special_builtin/5).
:- dom_op(terms, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(ptypes, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(ptypes, less_or_equal/2).
:- dom_op(ptypes, glb/3).
:- dom_op(ptypes, call_to_success_fact/9).
:- dom_op(ptypes, special_builtin/5).
:- dom_op(ptypes, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(eterms, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(eterms, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(eterms, less_or_equal/2).
:- dom_op(eterms, glb/3).
:- dom_op(eterms, call_to_success_fact/9).
:- dom_op(eterms, special_builtin/5).
:- dom_op(eterms, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(etermsvar, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(etermsvar, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(etermsvar, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(svterms, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(svterms, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(svterms, less_or_equal/2).
:- dom_op(svterms, glb/3).
:- dom_op(svterms, call_to_success_fact/9).
:- dom_op(svterms, special_builtin/5).
:- dom_op(svterms, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(deftypes, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(Vars,ASub,Proj))).
...
:- dom_op(deftypes, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(deftypes, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(nonrel_intervals, widen(Prime0, Prime1, NewPrime), ok(widen(Prime0,Prime1,NewPrime))).
:- dom_op(nonrel_intervals, compute_lub/2).
:- dom_op(nonrel_intervals, identical_abstract(ASub1, ASub2), ok(identical_abstract(ASub1, ASub2))).
...
:- dom_op(polyhedra, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
...
:- dom_op(polyhedra, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(polyhedra, less_or_equal/2).
:- dom_op(polyhedra, glb/3).
:- dom_op(polyhedra, eliminate_equivalent(TmpLSucc,LSucc), ok(abs_sort(TmpLSucc,LSucc))).
:- dom_op(polyhedra, call_to_success_fact/9).
:- dom_op(polyhedra, special_builtin/5).
:- dom_op(polyhedra, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(java_nullity, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(java_nullity, compute_lub/2).
:- dom_op(java_nullity, abs_sort/2).
:- dom_op(java_nullity, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(java_nullity, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(oo_son, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(oo_son, compute_lub/2).
:- dom_op(oo_son, identical_abstract/2).
:- dom_op(oo_son, abs_sort/2).
:- dom_op(oo_son, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(oo_son, less_or_equal/2).
:- dom_op(oo_son, glb/3).
:- dom_op(oo_son, call_to_success_fact/9).
:- dom_op(oo_son, special_builtin/5).
:- dom_op(oo_son, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(oo_son, compute_lub_el(ASub1,ASub2,ASub), ok(lub(ASub1,ASub2,ASub))).
:- endif.
% ---------------------------------------------------------------------------
:- if(defined(has_ciaopp_extra)).
...
:- dom_op(oo_shnltau, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(oo_shnltau, compute_lub/2).
:- dom_op(oo_shnltau, abs_sort/2).
:- dom_op(oo_shnltau, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(oo_shnltau, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
% :- dom_op(oo_shnltau, compute_lub_el(ASub1,ASub2,ASub), ok(lub(ASub1,ASub2,ASub))).
:- endif.
% ---------------------------------------------------------------------------
:- if(defined(has_ciaopp_extra)).
...
:- dom_op(oo_types, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(oo_types, compute_lub/2).
:- dom_op(oo_types, abs_sort/2).
:- dom_op(oo_types, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(oo_types, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(java_cha, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(java_cha, compute_lub/2).
:- dom_op(java_cha, abs_sort/2).
:- dom_op(java_cha, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
...
:- dom_op(java_cha, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(nf, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(nf, widencall/3).
:- dom_op(nf, widen/3).
:- dom_op(nf, compute_lub/2). 
:- dom_op(nf, compute_clauses_lub(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
:- dom_op(nf, identical_abstract/2).
:- dom_op(nf, fixpoint_covered(Prime0,Prime1), ok(less_or_equal(Prime0,Prime1))).
:- dom_op(nf, abs_sort/2).
:- dom_op(nf, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(nf, less_or_equal/2).
:- dom_op(nf, glb/3).
:- dom_op(nf, eliminate_equivalent/2).
:- dom_op(nf, call_to_success_fact/9).
:- dom_op(nf, special_builtin/5).
:- dom_op(nf, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(nf, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
:- dom_op(nf, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(nf, dom_statistics(Info), ok(statistics(Info))).
:- endif.
% ---------------------------------------------------------------------------
% determinism
:- if(defined(has_ciaopp_extra)).
...
:- dom_op(det, project(_Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Vars,Proj))).
:- dom_op(det, widencall/3).
:- dom_op(det, widen/3).
:- dom_op(det, compute_lub/2).
:- dom_op(det, compute_clauses_lub(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
:- dom_op(det, identical_abstract/2).
:- dom_op(det, fixpoint_covered(Prime0,Prime1), ok(less_or_equal(Prime0,Prime1))).
:- dom_op(det, abs_sort/2).
:- dom_op(det, extend(_Sg,Prime,Sv,Call,Succ), ok(extend(Prime,Sv,Call,Succ))).
:- dom_op(det, less_or_equal/2).
:- dom_op(det, glb/3).
:- dom_op(det, eliminate_equivalent/2).
:- dom_op(det, call_to_success_fact/9).
:- dom_op(det, special_builtin/5).
:- dom_op(det, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(det, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
:- dom_op(det, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
:- dom_op(det, obtain_info(Prop,Vars,ASub,Info), ok(obtain(Prop,Vars,ASub,Info))).
...
:- dom_op(det, dom_statistics(Info), ok(statistics(Info))).
:- endif.
% ===========================================================================
...
:- dom_op(res_plai, project(Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Sg,Vars,Proj))).
% :- dom_op(res_plai, widencall/3).
:- dom_op(res_plai, widen/3).
:- dom_op(res_plai, compute_lub/2).
:- dom_op(res_plai, compute_clauses_lub(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
% :- dom_op(res_plai, compute_clauses_glb(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
...
:- dom_op(res_plai, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(res_plai, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
% :- dom_op(res_plai, success_builtin(Type,Sv_uns,Condvars,_HvFv_u,Call,Succ), ok(success_builtin(Type,Sv_uns,Condvars,Call,Succ))).
...
:- dom_op(res_plai_stprf, project(Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Sg,Vars,Proj))).
:- dom_op(res_plai_stprf, widen/3).
:- dom_op(res_plai_stprf, compute_lub/2).
:- dom_op(res_plai_stprf, compute_clauses_lub(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
...
:- dom_op(res_plai_stprf, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(res_plai_stprf, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
...
:- dom_op(sized_types, project(Sg,Vars,_HvFv,ASub,Proj), ok(project(ASub,Sg,Vars,Proj))).
:- dom_op(sized_types, widen/3).
:- dom_op(sized_types, compute_lub/2).
:- dom_op(sized_types, compute_clauses_lub(Proj,ASub,Lub), ok(compute_clauses_lub(ASub,Proj,Lub))).
...
:- dom_op(sized_types, combined_special_builtin0(SgKey,Domains), ok(combined_special_builtin0(SgKey,Domains))).
:- dom_op(sized_types, split_combined_domain(ASub,ASubs,Doms), ok(split_combined_domain(ASub,ASubs,Doms))).
